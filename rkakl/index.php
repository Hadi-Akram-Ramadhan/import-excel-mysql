...
<body>
                    ...
                    <div class="form-container">
                        ...
                        <form action="" method="POST" enctype="multipart/form-data" id="uploadForm">
                            ...
                            <button type="submit" name="submit-dipa" value="Upload File XLS/XLSX" class="btn btn-primary btn-block">Submit</button>
                        </form>
        ...
        <div class="tutupincok"> 
            <div class="container">
                <div class="row">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item" data-toggle="tooltip" data-placement="top" title="Data Inputan">
                        ...
                        <div class="pencarian-container">
                            ...
                            <button type="button" class="pencarian-button-tutup"><i class="fas fa-times"></i></button>
                            </form>
                        </div>
                        <div>
                    ...
                    <div class="col col-lg-2 d-flex justify-content-right kanan">
                        <button type="button" class="btn btn-danger tutup-btn d-flex justify-content-center ml-3" id="tutupya"><i class="fa-solid fa-x"></i></button>
                    </div>
                    <style>
                        .tutup-btn{
                            width: 10%;
...
<script>
        ...
        function loadTable() {
            if (list_real) {
                const table_real = `<?php
                    // Database connection
                    $conn1 = new mysqli('localhost', 'root', '', 'eksel_ke_mysql');
                    ...
                    if (isset($_POST['delete-realisasi'])) {
                        $tableName = $conn1->real_escape_string($_POST['table_name']);
                        $stmt = $conn1->prepare("DELETE FROM realisasi WHERE nama_tabel = ?");
                    ...
                    $result = $conn1->query($selectQuery);
                    $nomor = 0;
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            $stmt = $conn1->prepare($TanggalQuery);
        ...
        document.getElementById('tableBody').addEventListener('click', function (event) {
            if (event.target.classList.contains('detail-btn')) {
                ...
                fetch('fetch_table_data.php?table=' + encodeURIComponent(tableName))
                    ...
                    .then(data => {
                        document.getElementById('table-data').innerHTML = data; // Update table with fetched data
                ...
                const dataKiriman = { tableName: tableName };
    ...
    <div class="row">
            ...
            <button type="button" class="btn btn-danger tutup-btn d-flex justify-content-center" id="tutupyalagi"><i class="fa-solid fa-x"></i></button>
            </div>
            <style>
                .tutup-btn{
                    width: 10%;
